...
class Cancel {
	...
	public function createDataSet() {
		...
		$query = "";
		if ($this->databaseConnection ()) {
			if ($this->user_role == "admin" || $this->user_role == "uniresort") {
				$query = $this->db_connection->prepare ( 'SELECT id_booking,  booking_st_id, booking_st_first_name,booking_st_last_name,  booking_check_in ,
													    ...
													    booking_pgate_code, booking_user_full_name,user_email,user_contact_number,user_agency_name,  booking_comment, booking_time_stamp FROM booking where booking_confirmed= "Canceled" order by id_booking DESC ' );
				$query->execute ();
