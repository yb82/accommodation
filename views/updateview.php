...
$(function() {
	...
	$("#boform").submit(function(e) {
	   	 ...
	   	 alert("Your changes have been submitted - Thank you");
		return true;
...
<form method="post" action="update.php" class="boform" id="boform" name="boform">
...
<li class="gfield">
	...
	<li class="gfield">
	<label class="gfield_label"> Student Email
	</label>
	<input type="text" name="email" value=<?php echo $update->getStudentEmail(); ?> /> 
	
	</li>
	<li class="gfield">
	<label class="gfield_label"> Agent Email
	</label>
	<input type="text" name="agent_email" value=<?php echo $update->getUserEmail(); ?> /> 
...
<!-- Airport Pick Up -->
	...
	<a href='display.php'>Back to Previous Page</a><input type="submit" class="login_button" name="u_submit"  value="Submit">
	</div>
